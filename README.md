<p align="center">
  <img src="https://raw.githubusercontent.com/mundaewon1/mundaewon30/main/moit-v3/img/moit-v3.png" width="900" alt="MOIT v3">
</p>
...
| **v3**  | Spring Boot, React, Axios, JPA, MyBatis, Oracle, JWT, Redis, Open API | React 기반 프론트엔드 전환 및 기능 확장, 인증·캐싱을 통한 성능 개선 |
| **v4**  | (예정)                                                                | 추가 기능 개발                                                      |
