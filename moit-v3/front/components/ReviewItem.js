...
export default function ReviewItem({ review, targetMeetupId, onLikeReview }) {
    ...
    const handleDetailClick = (reviewId) => {
        ...
        if (targetMeetupId) {
            router.push(
                `/user/meetup/review/detailreview?reviewId=${reviewId}&meetupId=${targetMeetupId}`,
            );
        } else {
            router.push(
                `/user/meetup/review/detailreview?reviewId=${reviewId}`,
            );
        }
    };
                    ...
                    <Space>
                        ...
                        <div>
                            ...
                            <div>
                                <Text type="secondary">
                                    {review.createdAt
                                        ? String(review.createdAt).substring(
                                              0,
                                              10,
                                          )
                                        : ""}
